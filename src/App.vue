            ...
            >
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <br/>
                        Перед началом работы, настоятельно рекомендуется ознакомиться с презентацией данного веб-приложения.
                        <br/>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            tab: 0,
            currentModule: 0,
            instruction: "<b>!</b> - Отрицание; <b>∧</b> - Конъюнкция; <b>∨</b> - Дизъюнкция; <b>→</b> - Импликация; <b>⇔</b> - Эквивалентность; <b>⊕</b> - XOR. <br/> Между символами требуетс пробел"
        }),
        computed: {},
        methods: {},
    };
